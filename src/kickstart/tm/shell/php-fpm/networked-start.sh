...
podman run --name $1 -d -p 8090:9000 --mount type=bind,src=/vagrant,dst=/opt/application/$1,ro=true --mount type=bind,src=/opt/project,dst=/opt/project  --mount type=bind,src=/opt/application/vendor,dst=/opt/application/vendor,ro=true php-fpm
